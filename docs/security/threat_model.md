...
| **Traversal Cursor Manipulation**           | Opaque base64url cursors with strict version, schema, traversal-context, size, and offset-bounds validation. The cursor carries no authorization decision and is not cryptographically integrity-protected. | `encodeCursor()`, `decodeCursor()`                                              |
